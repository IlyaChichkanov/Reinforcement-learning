...
Задачи семинаров — репетиция домашки: те же функции на знакомой среде. Решения семинаров лежат в [`solutions/`](solutions/).
...
* [`01-intro/seminar/dl_basics.ipynb`](01-intro/seminar/dl_basics.ipynb) — нейросети с нуля: модель с параметрами, функция потерь, градиентный спуск, backprop, первая сеть на PyTorch, классификация с кросс-энтропией. Внутри — дорожная карта на четыре недели с внешними ресурсами и упражнения с проверками для самопроверки.
