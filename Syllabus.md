...
* Cross-Entropy на Frozen Lake 8×8 (30): функции семинара без изменений, обучение, жадная версия политики
* Оценка политики по Монте-Карло (15): три политики со стандартными ошибками
* Своя среда (20): «управление запасами» со случайным спросом как `gym.Env`, перебор уровня base-stock политики
* Уравнения Беллмана на складе (35): модель $P$, $R$ дана; ценность ручной политики точно и по Монте-Карло, оптимальная политика заказов через value iteration
* Бонус (10): спрос, зависящий от скрытого дня недели; ручная политика, которой нужен день недели, — иллюстрация марковости наблюдения
